class Person(object):
    ...
    def __init__(self,name):
        super(Person,self).__init__()  #有可能用到父类的方法，调用一下
        self.name = name
...
def main():
    ...
    for i in range(15):
        ...
        #5.蠢觉把子弹安装到弹夹中
        #蠢觉.安装子弹到弹夹中(弹夹,子弹)
        chunjue.anzhuang_zidan(dan_jia,zi_dan)

    #6.蠢觉把弹夹安装到枪中
    #蠢觉.安装单价到枪中(枪,弹夹)
    chunjue.anzhuang_danjia(ak47,dan_jia)
    ...
    #7.蠢觉拿枪
    #蠢觉.拿枪(枪)
    chunjue.naqiang(ak47)
    print(chunjue)

    #8.创建一个敌人
    gebi_naxx = Person("Naxx")
    print(gebi_naxx)
